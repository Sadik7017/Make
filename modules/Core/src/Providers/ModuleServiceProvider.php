...
use Modules\Core\Http\Middleware\ModuleMiddleware;
use Modules\Core\Http\Middleware\ModuleMiddlewareManager;
...
abstract class ModuleServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            \Modules\Core\Console\Commands\ModuleHealthCheckCommand::class,
            \Modules\Core\Console\Commands\ModuleDependencyGraphCommand::class,
            \Modules\Core\Console\Commands\ModuleBackupCommand::class,
            \Modules\Core\Console\Commands\ModuleMiddlewareCommand::class,
        ]);
    }
} 