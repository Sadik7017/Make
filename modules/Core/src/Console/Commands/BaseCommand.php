...
use Modules\Core\Contracts\HandlesMissingInput;
...
abstract class BaseCommand extends Command implements HandlesMissingInput{
    ...
    public function __construct()
    {
        ...
        if ($this instanceof \Modules\Core\Contracts\ConfirmableCommand) {
