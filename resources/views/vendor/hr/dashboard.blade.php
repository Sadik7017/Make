            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('hr.attendance.index') }}" class="btn btn-success btn-block">
                                <i class="fas fa-clock"></i> Manage Attendance
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('hr.leaves.index') }}" class="btn btn-info btn-block">
                                <i class="fas fa-calendar-check"></i> Leave Requests
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('hr.performance.index') }}" class="btn btn-warning btn-block">
