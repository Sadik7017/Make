            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('hr.employees.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('emergency_contact.name') is-invalid @enderror" 
                                                id="emergency_contact_name" name="emergency_contact[name]" value="{{ old('emergency_contact.name') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('emergency_contact.relationship') is-invalid @enderror" 
                                                id="emergency_contact_relationship" name="emergency_contact[relationship]" value="{{ old('emergency_contact.relationship') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control @error('emergency_contact.phone') is-invalid @enderror" 
                                                id="emergency_contact_phone" name="emergency_contact[phone]" value="{{ old('emergency_contact.phone') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bank_details.bank_name') is-invalid @enderror" 
                                                id="bank_name" name="bank_details[bank_name]" value="{{ old('bank_details.bank_name') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bank_details.account_number') is-invalid @enderror" 
                                                id="account_number" name="bank_details[account_number]" value="{{ old('bank_details.account_number') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bank_details.branch') is-invalid @enderror" 
                                                id="branch" name="bank_details[branch]" value="{{ old('bank_details.branch') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bank_details.ifsc_code') is-invalid @enderror" 
                                                id="ifsc_code" name="bank_details[ifsc_code]" value="{{ old('bank_details.ifsc_code') }}" required>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h6 class="m-0 font-weight-bold text-primary">Account Setup</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        // Example: Update positions based on selected department
